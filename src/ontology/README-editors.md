These notes are for the EDITORS of cmixo
...
Make sure you have an ID range in the [idranges file](cmixo-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [cmixo-edit.owl](cmixo-edit.owl)

** DO NOT EDIT cmixo.obo OR cmixo.owl in the top level directory **

[../../cmixo.owl](../../cmixo.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/laurenechan/chemical-mixture-ontology) for details.
 ...
 * [cmixo-idranges.owl](cmixo-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/cmixo_terms.txt file
...
Note: the cmixo_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as cmixo.owl and cmixo.obo and places
 ...
 * https://github.com/laurenechan/chemical-mixture-ontology/releases
 * https://github.com/laurenechan/chemical-mixture-ontology/releases/new
...
what is in the `owl:versionIRI` of the derived cmixo.owl (`data-version` in
cmixo.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/cmixo.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/cmixo/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/laurenechan/chemical-mixture-ontology.svg?branch=master)](https://travis-ci.org/laurenechan/chemical-mixture-ontology)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/laurenechan](https://travis-ci.org/profile/laurenechan)
 2. click the "Sync account" button
 3. Click the tick symbol next to chemical-mixture-ontology
