 ...
 * [cmixo.yml](cmixo.yml)
     * Determines how your purl.obolibrary.org/obo/cmixo/ redirects will be handled
     ...
     * Paste in the contents of [cmixo.yml](cmixo.yml)
 ...
 * [cmixo.md](cmixo.md)
     ...
     * Paste in the contents of [cmixo.md](cmixo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
